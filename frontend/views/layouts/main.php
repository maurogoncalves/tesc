                        ...
                        'items' => [
                            ...
                            [
                                ...
                                'items' => [
                                    ...
                                    [
                                        'label' => 'Solicitações Aguardando Atendimento',
                                        'icon' => 'fa fa fa-bus',
                                    ...
                                    [
                                        'label' => 'Nova Solicitação de Crédito', 'icon' => 'fa fa-circle',
                                        'url' => '#',
                                        'items' => [
                                            [
                            ...
                            [
                                'label' => Usuario::permissao(Usuario::PERFIL_CONDUTOR) ? 'Início' : 'Condutores',
                                'icon' => 'fa fa-users',
                                'url' => '#',
                                'items' => [
                                    [
        ...
        <div class="container-header d-flex">
            ...
            <h1>
                ...
                <?= Breadcrumbs::widget([
                    ...
                    'homeLink' => ['label' => 'Página inicial', 'url' => ['site/index']]
                ]) ?>
            </section>
        </div>
...
<script>
    //Intecepta todas as requests para desabilitar o botão de submit
