...
<div class="alert alert-warning" style="background:#FFF200 !important;color:#000!important;" role="alert">
  ...
  <b>Favor informar os dados referentes a matrícula do (a) Aluno (a) para o <span style="color:#297DBA!important;">Ano Letivo Atual</span>. Caso o HORÁRIO DE ENTRADA e HORÁRIO DE SAÍDA estejam incorretos, altere no Cadastro do (a) Aluno (a) e crie uma <span style="color:#5DC334!important;">NOVA SOLICITAÇÃO DE TRANSPORTE</span></b>
</div>
...
<div id="novaSolicitacao" style="display:none !important">
  <div class="row">
    ...
    <div id="inputs-barreira">
      ...
      <div class="col-md-12" style="" id="motivoBarreiraFisica">
  ...
  <div class="box box-solid with-border">
    ...
    <div>
      ...
      <div class="row" style="background-color: #eee; padding-left: 20px; margin: 0px;">
        <?php echo $form->field($model, 'checkSed')->checkBox(['id' => 'checkSed']); ?>
      </div>
      ...
      <div class="row" id="validarSolicitacaoVizinho" style="display:none; background-color: #fff; padding-left: 20px; margin: 0px;">
        <?php echo $form->field($model, 'checkVizinho')->checkBox(['id' => 'checkVizinho']); ?>
      </div>
      <div class="row" id="validarMemorando" style="display:none; background-color: #eee; padding-left: 20px; margin: 0px;">
        <?php echo $form->field($model, 'checkMemorando')->checkBox(['id' => 'checkMemorando']); ?>
      </div>
    </div>
  </div>
...
<script type="text/javascript">
  ...
  var ra = <?= $model->aluno->RA ?>;
  var serie = <?= $model->aluno->serie ?>;
  ...
  function desabilitarCheckboxes(){
      ...
      $("#validarMemorando").hide();
      $("#checkMemorando").attr('required', false); 
      $("#checkMemorando").prop("checked", false);
  }
  $("#solicitacaotransporte-tipofrete").change((event) => {
    ...
    if(tipoFrete == 2){
      ...
      if(novaSolicitacao){
        ...
        $("#checkMemorando").attr('required', true); 
      }
    } else {
      desabilitarCheckboxes();
      ...
      .done(function(response) {
        if(response.status){
          ...
          $("#novaSolicitacao").hide();
		   window.location.href = 'index.php?r=renovacao/index&ra='+ra+'&idAluno='+idAluno; 	
		  // //alteracao mauro 27/10/2021
		  // if(serie >= 16 || serie <= 27){ //  as series entre 16 e 27 são ensino EJA e são renovados a cada 6 meses
