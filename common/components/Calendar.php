...
*/
    private function MostreSemanas()
    {
        $semanas = "DSTQQSS";
     
        for( $i = 0; $i < 7; $i++ )
         echo "<td class='dia-semana'><strong>".$semanas{$i}."</strong></td>";
    ...
    public function MostreCalendario( $mes  )
    {
        ...
        echo "<table border = 0 cellspacing = '0' align = 'center' class='calendario'>";
         echo "<tr>";
             echo "<td colspan='7' class='cabecalho'><h1>".$nome_mes."</h1></td>";
         echo "</tr>";
         echo "<tr>";
        ...
        for( $linha = 0; $linha < 6; $linha++ )
        {
           ...
           for( $coluna = 0; $coluna < 7; $coluna++ )
           {
            ...
            echo " align='center' valign='center' class='dia'><strong>";
